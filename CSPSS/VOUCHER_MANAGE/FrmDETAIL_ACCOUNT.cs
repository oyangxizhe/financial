...
{
    public partial class FrmDETAIL_ACCOUNT : Form
    {
        ...
        GENERAL_ACCOUNT ga = new GENERAL_ACCOUNT();
        private string _ACCOUNTING_PERIOD_START_PERIOD;
        public string ACCOUNTING_PERIOD_START_PERIOD
        {

            set { _ACCOUNTING_PERIOD_START_PERIOD = value; }
            get { return _ACCOUNTING_PERIOD_START_PERIOD; }

        }
        private string _ACCOUNTING_PERIOD_EXPIRATION_PERIOD;
        public string ACCOUNTING_PERIOD_EXPIRATION_PERIOD
        {

            set { _ACCOUNTING_PERIOD_EXPIRATION_PERIOD = value; }
            get { return _ACCOUNTING_PERIOD_EXPIRATION_PERIOD; }

        }
    
        public FrmDETAIL_ACCOUNT()
        {
            InitializeComponent();
        }
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FrmDETAIL_ACCOUNT));
            ...
            this.btnToExcel.Location = new System.Drawing.Point(676, 43);
            ...
            this.Name = "FrmDETAIL_ACCOUNT";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "明细帐查询作业";
            this.Load += new System.EventHandler(this.FrmGENERAL_ACCOUNT_Load);
        ...
        public  void Bind()
        {
            ...
            dt = basec.getdts(ga.getsql+ga.getsql1);
            dataGridView1.DataSource = ga.GET_TABLEINFO (dt);
            //dataGridView1.DataSource = ga.GetTableInfo_INITAIL();
            dgvStateControl();
        ...
        #endregion
        private void FrmGENERAL_ACCOUNT_Load(object sender, EventArgs e)
        {
        ...
        private void dgvStateControl()
        {
            ...
            dataGridView1.Columns["科目名称"].Width = 150;
            dataGridView1.Columns["日期"].Width = 80;
            dataGridView1.Columns["凭证号"].Width = 100;
            dataGridView1.Columns["摘要"].Width = 80;
            dataGridView1.Columns["借方"].Width = 100;
            dataGridView1.Columns["贷方"].Width = 100;
            dataGridView1.Columns["方向"].Width = 40;
            dataGridView1.Columns["余额"].Width = 100;

            dataGridView1.Columns["日期"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dataGridView1.Columns["凭证号"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dataGridView1.Columns["摘要"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dataGridView1.Columns["方向"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleCenter;
            dataGridView1.Columns["借方"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
            dataGridView1.Columns["贷方"].DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight;
        ...
        private void dataGridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            if (getdata != 0)
            {
                if (getdata == 1)
                {
                    ...
                    /*FINANCIAL.VOUCHER_MANAGE.FrmSellTableT.data4[0] = "doubleclick";
                    FINANCIAL.VOUCHER_MANAGE.FrmSellTableT.data1[0] = s1;
                    FINANCIAL.VOUCHER_MANAGE.FrmSellTableT.data1[1] = s2;
                    FINANCIAL.VOUCHER_MANAGE.FrmSellTableT.data1[2] = s3;
                    FINANCIAL.VOUCHER_MANAGE.FrmSellTableT.data1[3] = s4;
                    FINANCIAL.VOUCHER_MANAGE.FrmSellTableT.data1[4] = s5;*/
            ...
            {
                /*FrmGENERAL_ACCOUNTT frm = new FrmGENERAL_ACCOUNTT(this);
        ...
        private void btnToExcel_Click(object sender, EventArgs e)
        {
            if (dt.Rows.Count > 0)
            {
                ...
                bc.dgvtoExcel(dataGridView1, "总帐明细");
        ...
        private void ak()
        {
           ...
           /* string sql1 = @" where B.CYCODE like '%" + comboBox1.Text + "%' AND B.CYNAME LIKE '%" + textBox1.Text + "%'";
